...
def main():
    ...
    if len(sys.argv) > 1:
        # 如果有参数，直接调用相应的功能
        parser = argparse.ArgumentParser(description="Codegen2Excel工具UI界面")
        parser.add_argument("--convert", action="store_true", help="从现有Python文件转换")
        parser.add_argument("--record", action="store_true", help="启动Playwright录制并转换")
